...
<script>
import OrchidHospice from "./components/InformationAboutUs/InfosUs.vue";
...
export default {
  components: { Header, ContactUs, ComfortableCare, OrchidHospice, OurServeces, Insurances, Testimonials },
  name: "App",
};
</script>
